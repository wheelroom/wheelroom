...
cp src-table-wheel/models/table/fragment.js src/copied-fragments/table-fragment.js 
...
cp src-text-wheel/models/text/fragment.js src/copied-fragments/text-fragment.js 
...
cp src-topic-wheel/models/action/fragment.js src/copied-fragments/action-fragment.js 
