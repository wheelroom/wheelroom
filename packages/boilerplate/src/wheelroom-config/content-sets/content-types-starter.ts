...
interface PageModel {
  fields: {
    path: string
    sections: Array<'starterBlogSection' | 'starterBlogListSection' | 'starterBlockSection' | 'starterCardSection' | 'starterFeaturedSection' | 'starterHeadlineSection' | 'starterHeroSection' | 'starterQuoteSection' | 'starterShowcaseSection' | 'starterTextSection' | 'siteHeader' | 'siteFooter' | 'tableSectionPrice' | 'tableSectionTable'>
