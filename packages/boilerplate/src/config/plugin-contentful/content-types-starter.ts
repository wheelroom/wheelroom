...
interface PageSectionModel {
  fields: {
    variation?: 'block-wr' | 'blog-wr' | 'card-wr' | 'divider-wr' | 'featured-wr' | 'gallery-wr' | 'headline-wr' | 'hero-wr' | 'image-wr' | 'navigation-wr' | 'price-table-wr' | 'quote-wr' | 'showcase-wr' | 'text-wr' | 'video-wr'
    topics?: Array<'freeForEveryoneTopic' | 'githubProfileTopic' | 'myGreatBlogProfile' | 'nonprofitTopic' | 'openSourceTopic' | 'wheelroomConnectsTopic'>
...
interface BlogModel {
  fields: {
    ...
    text: string
    topics?: Array<'freeForEveryoneTopic' | 'githubProfileTopic' | 'myGreatBlogProfile' | 'nonprofitTopic' | 'openSourceTopic' | 'wheelroomConnectsTopic'>
    profiles?: Array<'freeForEveryoneTopic' | 'githubProfileTopic' | 'myGreatBlogProfile' | 'nonprofitTopic' | 'openSourceTopic' | 'wheelroomConnectsTopic'>
    seoTitle?: string
    seoDescription?: string
    seoImage?: boolean
    seoKeywords?: string[]
