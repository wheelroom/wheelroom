...
interface PageModel {
  fields: {
    path: string
    sections: Array<'homeHero' | 'homeBlock' | 'exampleText' | 'exampleHeadline' | 'exampleFeatured' | 'exampleBlock' | 'exampleCard' | 'exampleGallery' | 'exampleImage' | 'exampleQuote' | 'exampleShowcase' | 'siteHeader' | 'siteFooter'>
    theme?: 'light' | 'dark'
    seoTitle?: string
...
interface BlogModel {
  fields: {
    ...
    text: string
    categories?: string[]
    authors?: Array<'promiseTopic' | 'openSourceTopic' | 'nonprofitTopic' | 'freeForEveryoneTopic' | 'exampleTopic' | 'githubProfileTopic'>
    seoTitle?: string
    seoDescription?: string
    seoImage?: boolean
    seoKeywords?: string[]
