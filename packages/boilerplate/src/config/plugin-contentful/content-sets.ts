  ...
  boilerplate: {
    ...
    merkverwateringText: {
      fields: {
        ...
        title: 'Tekst over merkverwatering',
      },
      model: 'textSection',
    },
    merkarchitectuurText: {
      fields: {
        ...
        title: 'Tekst over merkarchitectuur',
      },
      model: 'textSection',
    },
    naamcreatieText: {
