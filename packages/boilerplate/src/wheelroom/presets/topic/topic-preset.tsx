...
import { TopicPresetStyle } from './topic-preset-style'
...
export interface TopicTreeProps {
  ...
  treeStyle?: TopicPresetStyle
}

export const TopicPreset = (props: TopicTreeProps) => {
  ...
  return fullTopicAsLink ? (
    <ActionPreset {...props.topic.actions[0]} treeStyle={treeStyle.ncss}>
      <TopicBody {...props} />
    </ActionPreset>
  ) : (
