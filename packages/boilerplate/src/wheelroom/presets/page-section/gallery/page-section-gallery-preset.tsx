...
import { PageSectionGalleryPresetStyle } from './page-section-gallery-preset-style'
import { TopicPreset } from '../../topic/topic-preset'

export const PageSectionGalleryPreset = (props: {
  /** Contains the topic to render */
  pageSection: PageSectionProps
  /** Styles to use */
  treeStyle: PageSectionGalleryPresetStyle
