...
export const argvContent: ArgvContent = {
  allFieldTypesPage1: {
    fields: {
      dateField: '2019-06-03T00:00+01:00',
      dropdownField: ['choose', 'here'],
      imageField: true,
      longTextField: 'Content for testing this field',
      multipleComponentsField: ['firstSection', 'secondSection'],
      numberField: 25,
      ...
      singleComponentField: 'noFragmentModelPage',
      tagsField: ['some', 'tags'],
  ...
  allFieldTypesPage2: {
    fields: {
      ...
      dropdownField: ['more', 'choice', 'here'],
      imageField: true,
      longTextField: 'Content for testing this field',
      multipleComponentsField: ['firstSection', 'secondSection'],
      numberField: 25,
